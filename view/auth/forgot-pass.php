<div class="w-full my-2">
	<div class="lg:p-12 max-w-[500px] lg:my-0 mx-auto p-6 space-y-">
		<form id="forget-password-form" action="#" method="post" class="p-6 lg:p-10 lg:py-[5rem] space-y-3 relative bg-white shadow-lg rounded">
			...
			<p class="text-base text-center">Please enter your username or email address. You will receive a link to create a new password via email.</p>
            <div class="forgot-error text-base text-red-500 p-4 rounded bg-red-50" style="display:none"></div>
            <div class="forgot-success text-base text-green-500 p-4 rounded bg-green-50" style="display:none"></div>
			...
			<div class="input-group">
				<button type="submit" class="block border-0 w-full bg-[#f7b134] rounded text-white"> Submit </button>
